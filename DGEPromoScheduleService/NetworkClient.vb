...
Public Class NetworkClient
   ...
   Private Sub ConnectCallback(ByVal ar As IAsyncResult)
      ...
      Catch ex As Exception
         ' Handle the exception.
         RaiseEvent NetClientError(ex.Message)
   ...
   Sub Send(ByVal aMessageText As String)
      ...
      Try
         ...
         If mSocket Is Nothing Then
            RaiseEvent NetClientError("Send: Socket not available to send " & aMessageText.TrimEnd(mCrLf.ToCharArray))
         Else
   ...
   Private Sub ReceiveCallback(ByVal ar As IAsyncResult)
      ...
      Try
         ...
         If lBytesRead > 0 Then
            ...
            If lData.IndexOf(mCrLf) > -1 Then
               While lData.IndexOf(mCrLf) > -1
                  RaiseEvent DataReceived(lData.Substring(0, lData.IndexOf(mCrLf)))
                  mSB.Remove(0, lData.IndexOf(mCrLf) + 2)
                  lData = mSB.ToString
               End While
