<System.ComponentModel.RunInstaller(True)> Partial Class ProjectInstaller
    ...
    Private Sub InitializeComponent()
      ...
      'SvcProcessInstaller
      '
      Me.SvcProcessInstaller.Account = System.ServiceProcess.ServiceAccount.LocalSystem
      Me.SvcProcessInstaller.Password = Nothing
      Me.SvcProcessInstaller.Username = Nothing
      '
      'SvcInstaller
      '
      Me.SvcInstaller.Description = "Diamond Game Enterprises Promo Ticket Processor v" & My.Application.Info.Version.ToString
      Me.SvcInstaller.DisplayName = "DGE Promo Ticket Schedule Processor"
      Me.SvcInstaller.ServiceName = "DGEPromoScheduleService"
