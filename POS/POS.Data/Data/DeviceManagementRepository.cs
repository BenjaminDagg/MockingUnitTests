...
namespace POS.Infrastructure.Data
{
    public class DeviceManagementRepository : POSDbService, IDeviceManagementRepository
    {
        ...
        {
            const string sql = @"SELECT MACH_NO, CASINO_MACH_NO, MODEL_DESC, IP_ADDRESS, REMOVED_FLAG, BALANCE, LAST_ACTIVITY, ACTIVE_FLAG FROM [dbo].[MACH_SETUP] WHERE MACH_NO = @MachNo AND IP_ADDRESS = @IpAddress AND REMOVED_FLAG = @RemovedFlag";
        ...
        {
            const string sql = @"SELECT MACH_NO, CASINO_MACH_NO, MODEL_DESC, IP_ADDRESS, REMOVED_FLAG, BALANCE, LAST_ACTIVITY, ACTIVE_FLAG FROM [dbo].[MACH_SETUP] WHERE REMOVED_FLAG = @RemovedFlag";
