...
## Fixed
 ...
 - Updated the assembly version to 2.0.0.1 and assembly file version to 1.0.0.1

## 08/24/2021
## Fixed
- 64825 Deferred Fix - Bug 63682: MOL Centrolink 20210720.5 - Deals Status list incorrectly sets "Recommended Close" to "no" for deals with CLOSE_RECOMMENDED set to true in the database 
- 64827 Deferred Fix - Bug 63690: MOL Centrolink 20210720.5 - Deal Status - Deal completed percent is 0% for all deals 
- 64833 Deferred Fix - Bug 63795: MOL Centrolink 20210720.5 - Deal Setup List - Number of Rolls values for all deals do not match NUMB_ROLLS field in DEAL_SETUP table 
- 64837 Deferred Fix - Bug 63797: MOL Centrolink 20210720.5 - Deal Setup List - Tab Amount of 0.50 gets rounded down to zero 