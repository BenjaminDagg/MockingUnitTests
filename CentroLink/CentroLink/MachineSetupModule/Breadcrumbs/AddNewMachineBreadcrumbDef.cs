...
{
    /// <summary>
    /// Breadcrumb definition for Add New Machine with parent of Machine Setup
    /// </summary>
    /// <seealso cref="IBreadcrumbDefinition" />
    public class AddNewMachineBreadcrumbDef : IBreadcrumbDefinition
    {
        /// <summary>
        /// Gets the breadcrumb.
        /// </summary>
        ...
        public BreadcrumbItem GetBreadcrumb()
        {
            ...
            var addNewMachineBreadcrumb = new BreadcrumbItem(parentBreadCrumb, typeof(MachineSetupAddViewModel), "Add New Machine");
