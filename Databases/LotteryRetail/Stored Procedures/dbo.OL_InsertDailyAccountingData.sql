...
/*
--------------------------------------------------------------------------------
Procedure: OL_InsertDailyAccountingData
...
---------------------------------------------------------------------------------
*/
CREATE PROCEDURE [dbo].[OL_InsertDailyAccountingData] @Date DATETIME
...
SET @Success = 1
SET @StoredProc = 'OL_InsertDailyAccountingData'
SET @Transferred = 0
...
--------------------------------------------------------------------------------
*/
DELETE FROM dbo.OL_DailyAccounting
WHERE AccountingDate = @AccountingDate AND Transferred = 0

/*
--------------------------------------------------------------------------------
   Select machine stats data and insert into OL_DailyAccounting.
--------------------------------------------------------------------------------
*/
