...
/*
--------------------------------------------------------------------------------
Procedure: rpt_Theoretical_Hold user stored procedure.

  Created: 01/14/2003 by Terry Watkins  

  Purpose: Returns summarized data for the Theoretical Hold report
...
Date       By                Database Version
  Change Description
--------------------------------------------------------------------------------
2003-01-14 Terry Watkins
  Initial Coding.

2003-09-15 Chris C.    
  Modification for Dakota.

2004-08-17 Terry Watkins
  Modified to work correctly for Multi-Denom Paper deals.

2004-10-18 Terry Watkins
  Modified to use MACHINE_STATS instead of DEAL_STATS.

2007-08-21 Terry Watkins     v6.0.1
  Modified to exclude Bingo Deals.
--------------------------------------------------------------------------------
*/
CREATE PROCEDURE [dbo].[rpt_Theoretical_Hold] (@DealCode Integer, @DealNumber Integer)
AS
