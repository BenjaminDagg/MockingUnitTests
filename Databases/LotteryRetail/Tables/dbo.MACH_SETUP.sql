...
[GAME_RELEASE] [varchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_MACH_SETUP_GAME_RELEASE] DEFAULT (''),
[GAME_CORE_LIB_VERSION] [varchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_MACH_SETUP_GAME_CORE_LIB_VERSION] DEFAULT (''),
[GAME_LIB_VERSION] [varchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_MACH_SETUP_GAME_LIB_VERSION] DEFAULT (''),
[MATH_DLL_VERSION] [varchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_MACH_SETUP_MATH_DLL_VERSION] DEFAULT (''),
[MATH_LIB_VERSION] [varchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_MACH_SETUP_MATH_LIB_VERSION] DEFAULT (''),
[OS_VERSION] [varchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_MACH_SETUP_OS_VERSION] DEFAULT (''),
[SYSTEM_VERSION] [varchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_MACH_SETUP_SYSTEM_VERSION] DEFAULT (''),
[SYSTEM_LIB_A_VERSION] [varchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_MACH_SETUP_SYSTEM_LIB_A_VERSION] DEFAULT (''),
[SYSTEM_CORE_LIB_VERSION] [varchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_MACH_SETUP_SYSTEM_CORE_LIB_VERSION] DEFAULT (''),
[InstallDate] [datetime] NULL CONSTRAINT [DF_MACH_SETUP_InstallDate] DEFAULT (getdate()),
[RemoveDate] [datetime] NULL,
[MultiGameEnabled] [bit] NOT NULL CONSTRAINT [MultiGameEnabled_CONSTRAINT] DEFAULT ((0)),
...
10-23-2015 Josh Brown
  Modified to use location ID, added logic to
  clear the RemoveDate when machine is reactivated
--------------------------------------------------------------------------------
*/
...
AS
	...
	-- If REMOVED_FLAG is updated from 0 to 1, add a RemoveDate
	UPDATE ms
	SET RemoveDate = GETDATE()
	FROM  ( SELECT I.MACH_NO, I.LOCATION_ID
		FROM inserted I
		JOIN deleted D ON I.MACH_NO = D.MACH_NO AND I.LOCATION_ID = D.LOCATION_ID
		WHERE I.REMOVED_FLAG = 1 AND D.REMOVED_FLAG = 0
		) dm
	INNER JOIN [dbo].[MACH_SETUP] AS ms
		 ON dm.MACH_NO = ms.MACH_NO AND dm.LOCATION_ID = ms.LOCATION_ID
	
	-- If REMOVED_FLAG is updated from 1 to 0, remove the RemoveDate	 
	UPDATE ms
	SET RemoveDate = NULL
	FROM  ( SELECT I.MACH_NO, I.LOCATION_ID
		FROM inserted I
		JOIN deleted D ON I.MACH_NO = D.MACH_NO AND I.LOCATION_ID = D.LOCATION_ID
		WHERE I.REMOVED_FLAG = 0 AND D.REMOVED_FLAG = 1
		) dm
	INNER JOIN [dbo].[MACH_SETUP] AS ms
		 ON dm.MACH_NO = ms.MACH_NO AND dm.LOCATION_ID = ms.LOCATION_ID
GO
