...
[PendingMachineState] [bit] NOT NULL CONSTRAINT [DF_SiteStatus_PendingMachineState] DEFAULT ((0)),
[StatusCode] [varchar] (1) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_RetailSiteStatus_StatusCode] DEFAULT ((1))
) ON [PRIMARY]
GO
