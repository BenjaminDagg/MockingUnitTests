...
(
[OLDailyAccountingID] [int] NOT NULL IDENTITY(1, 1),
[RetailOLDailyAccountingID] [int] NOT NULL,
...
GO
ALTER TABLE [dbo].[OL_DailyAccounting] ADD CONSTRAINT [PK_OL_DailyAccounting] PRIMARY KEY CLUSTERED  ([OLDailyAccountingID]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
